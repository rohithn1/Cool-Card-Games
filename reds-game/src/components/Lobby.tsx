    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-950 via-emerald-900 to-teal-950 flex items-center justify-center p-4">
      ...
      >
        ...
        >
          ...
          <p className="mt-4 text-emerald-600/60"><span className="text-emerald-400">v</span><span className="text-emerald-500">1</span><span className="text-emerald-400">.</span><span className="text-emerald-500">1</span><span className="text-emerald-400">.</span><span className="text-emerald-500">7</span>-beta</p>
        </motion.div>
      </motion.div>
    </div>
  );
